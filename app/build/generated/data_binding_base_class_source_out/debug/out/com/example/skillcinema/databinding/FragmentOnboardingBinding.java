...
public final class FragmentOnboardingBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout onboardingFragment;
  ...
  private FragmentOnboardingBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ImageView imageView4, @NonNull ConstraintLayout onboardingFragment) {
  ...
  public static FragmentOnboardingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ConstraintLayout onboardingFragment = (ConstraintLayout) rootView;

      return new FragmentOnboardingBinding((ConstraintLayout) rootView, imageView, imageView2,
          imageView3, imageView4, onboardingFragment);
    }
