...
public final class FragmentSeachBinding implements ViewBinding {
  ...
  private FragmentSeachBinding(@NonNull FrameLayout rootView, @NonNull CardView cardView2,
      @NonNull RecyclerView filmRecycler, @NonNull ImageButton filtr,
      @NonNull ImageView imageContact, @NonNull ImageView imageHome, @NonNull ImageView imagePoisk,
      @NonNull TextView searchEditText, @NonNull ImageView searchRectangle) {
    this.rootView = rootView;
    this.cardView2 = cardView2;
    this.filmRecycler = filmRecycler;
    this.filtr = filtr;
  ...
  public static FragmentSeachBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.film_recycler;
      RecyclerView filmRecycler = ViewBindings.findChildViewById(rootView, id);
      if (filmRecycler == null) {
        break missingId;
      }
      ...
      return new FragmentSeachBinding((FrameLayout) rootView, cardView2, filmRecycler, filtr,
