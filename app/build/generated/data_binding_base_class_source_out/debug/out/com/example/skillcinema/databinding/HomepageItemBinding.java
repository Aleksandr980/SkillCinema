...
public final class HomepageItemBinding implements ViewBinding {
  ...
  private HomepageItemBinding(@NonNull ConstraintLayout rootView, @NonNull AppCompatTextView genre,
      @NonNull ConstraintLayout itemHomepage, @NonNull AppCompatImageView poster,
  ...
  public static HomepageItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.homepage_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HomepageItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HomepageItemBinding((ConstraintLayout) rootView, genre, itemHomepage, poster,
          title);
    }
