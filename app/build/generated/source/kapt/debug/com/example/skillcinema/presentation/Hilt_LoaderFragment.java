 ...
 */
public abstract class Hilt_LoaderFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LoaderFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LoaderFragment_GeneratedInjector) this.generatedComponent()).injectLoaderFragment(UnsafeCasts.<LoaderFragment>unsafeCast(this));
    }
  }
