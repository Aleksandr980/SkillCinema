 ...
 */
public abstract class Hilt_Onboarding2Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Onboarding2Fragment() {
    super();
  }

  Hilt_Onboarding2Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Onboarding2Fragment_GeneratedInjector) this.generatedComponent()).injectOnboarding2Fragment(UnsafeCasts.<Onboarding2Fragment>unsafeCast(this));
    }
  }
