 ...
 */
public abstract class Hilt_Onboarding3Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_Onboarding3Fragment() {
    super();
  }

  Hilt_Onboarding3Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((Onboarding3Fragment_GeneratedInjector) this.generatedComponent()).injectOnboarding3Fragment(UnsafeCasts.<Onboarding3Fragment>unsafeCast(this));
    }
  }
