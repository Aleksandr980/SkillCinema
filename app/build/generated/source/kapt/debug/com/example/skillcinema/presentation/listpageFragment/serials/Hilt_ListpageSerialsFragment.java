 ...
 */
public abstract class Hilt_ListpageSerialsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListpageSerialsFragment() {
    super();
  }

  Hilt_ListpageSerialsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListpageSerialsFragment_GeneratedInjector) this.generatedComponent()).injectListpageSerialsFragment(UnsafeCasts.<ListpageSerialsFragment>unsafeCast(this));
    }
  }
