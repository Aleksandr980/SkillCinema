 ...
 */
public abstract class Hilt_ListpageTop250Fragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_ListpageTop250Fragment() {
    super();
  }

  Hilt_ListpageTop250Fragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ListpageTop250Fragment_GeneratedInjector) this.generatedComponent()).injectListpageTop250Fragment(UnsafeCasts.<ListpageTop250Fragment>unsafeCast(this));
    }
  }
