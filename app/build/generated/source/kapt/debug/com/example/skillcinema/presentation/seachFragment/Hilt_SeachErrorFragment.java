 ...
 */
public abstract class Hilt_SeachErrorFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeachErrorFragment() {
    super();
  }

  Hilt_SeachErrorFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeachErrorFragment_GeneratedInjector) this.generatedComponent()).injectSeachErrorFragment(UnsafeCasts.<SeachErrorFragment>unsafeCast(this));
    }
  }
