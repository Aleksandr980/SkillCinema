 ...
 */
public abstract class Hilt_SeachFoundFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeachFoundFragment() {
    super();
  }

  Hilt_SeachFoundFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeachFoundFragment_GeneratedInjector) this.generatedComponent()).injectSeachFoundFragment(UnsafeCasts.<SeachFoundFragment>unsafeCast(this));
    }
  }
