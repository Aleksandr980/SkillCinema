 ...
 */
public abstract class Hilt_SeachFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SeachFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SeachFragment_GeneratedInjector) this.generatedComponent()).injectSeachFragment(UnsafeCasts.<SeachFragment>unsafeCast(this));
    }
  }
