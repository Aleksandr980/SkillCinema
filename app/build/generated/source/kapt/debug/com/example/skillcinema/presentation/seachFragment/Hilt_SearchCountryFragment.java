 ...
 */
public abstract class Hilt_SearchCountryFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchCountryFragment() {
    super();
  }

  Hilt_SearchCountryFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchCountryFragment_GeneratedInjector) this.generatedComponent()).injectSearchCountryFragment(UnsafeCasts.<SearchCountryFragment>unsafeCast(this));
    }
  }
