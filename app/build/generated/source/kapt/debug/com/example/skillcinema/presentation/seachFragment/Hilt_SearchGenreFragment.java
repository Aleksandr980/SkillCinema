 ...
 */
public abstract class Hilt_SearchGenreFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchGenreFragment() {
    super();
  }

  Hilt_SearchGenreFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchGenreFragment_GeneratedInjector) this.generatedComponent()).injectSearchGenreFragment(UnsafeCasts.<SearchGenreFragment>unsafeCast(this));
    }
  }
