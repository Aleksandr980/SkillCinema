 ...
 */
public abstract class Hilt_SearchYearFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_SearchYearFragment() {
    super();
  }

  Hilt_SearchYearFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((SearchYearFragment_GeneratedInjector) this.generatedComponent()).injectSearchYearFragment(UnsafeCasts.<SearchYearFragment>unsafeCast(this));
    }
  }
