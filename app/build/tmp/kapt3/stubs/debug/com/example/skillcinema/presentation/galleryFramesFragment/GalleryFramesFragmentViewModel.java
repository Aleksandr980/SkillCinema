...
public final class GalleryFramesFragmentViewModel extends androidx.lifecycle.ViewModel {
    ...
    private GalleryFramesFragmentViewModel(com.example.skillcinema.domain.GetGalleryPagedListRepositoryUseCase getGalleryPagedListRepositoryUseCase) {
        super();
    }
    ...
    public GalleryFramesFragmentViewModel() {
        super();
    }
    ...
    public final void loadGalleryFramesFragment(int idGallary) {
    }
}